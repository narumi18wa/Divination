...
local function onTouch(event)
	if (event.phase == "ended")then
        ...
        composer.removeScene("divination_1", false)
		return true
	end
end
...
function scene:create( event )
	...
	--画像表示
	happy_image = display.newImage("happy.png", _W/2, _H/4)
	happy_image:scale(0.2, 0.2)
	
	--テキスト表示
	text = display.newText("今日のあなたの運勢は絶好調！\n 天気にも恵まれて１日ハッピーに過ごせるでしょう",
...
function scene:show( event )
    ...
    elseif phase == "did" then
        ...
        happy_image:addEventListener("touch", onTouch)
