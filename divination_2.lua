...
local function onTouch(event)
	if (event.phase == "ended")then
        ...
        composer.removeScene("divination_2", false)
		return true
	end
end
...
function scene:create( event )
	...
	--画像表示
	good_image = display.newImage("good.png", _W/2, _H/4)
	good_image:scale(0.2, 0.2)
	
	--テキスト表示
	text = display.newText("今日のあなたの運勢はまぁまぁ。とにかくまぁまぁなので何事もほどほどに",
...
function scene:show( event )
    ...
    elseif phase == "did" then
        ...
        good_image:addEventListener("touch", onTouch)
